...
class PageWorker extends CI_Controller 
{
	/**********************************************************************************************************
	...
	* 					: If validation success, this function will load the worker main page
	...
	function Index()
	{
		...
		if(! $this->session->userdata('session_data'))
		{
		...
		else
			{
				...
				$this->load->view('Worker/WorkerMain', $sess_data);
			}
	}
}

/**************************************************************************************************************
* End of PageWorker.php
**************************************************************************************************************/
?>
