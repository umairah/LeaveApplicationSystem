...
/**************************************************************************************************************
* File Name			: CheckLeave.php
* Description		: Retrieve selected user leave application status information
...
class CheckLeave extends CI_Controller 
{
	...
	* 					: If there is session, it will retrieve the leave application status information of the 
	...
	**********************************************************************************************************/
	function Index()
	{
		...
		{
			$check_leave['leave_data'] = $this->LeaveModel->CheckLeaveStatus();
			
			$this->load->view('Worker/CheckApplicationLeave', $check_leave);
		}				
	}
}

/**************************************************************************************************************
* End of CheckLeave.php
**************************************************************************************************************/
?>